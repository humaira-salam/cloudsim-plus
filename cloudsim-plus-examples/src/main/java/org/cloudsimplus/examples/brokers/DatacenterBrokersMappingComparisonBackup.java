 ...
 */
public class DatacenterBrokersMappingComparisonBackup {
    ...
    public static void main(String[] args) {
        ...
        new DatacenterBrokersMappingComparisonBackup(broker0, random0, verbose);
        ...
        new DatacenterBrokersMappingComparisonBackup(broker1, random1, verbose);
        ...
        new DatacenterBrokersMappingComparisonBackup(broker2, random2, verbose);
     ...
     */
    public DatacenterBrokersMappingComparisonBackup(final DatacenterBroker broker, final ContinuousDistribution random, final boolean verbose) {
